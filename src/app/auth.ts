...
export const { handlers, signIn, signOut, auth } = NextAuth({
  ...
  callbacks: {
    ...
    // This callback is used to redirect users after sign-in and this done because I want to redirect users to their respective dashboard based on their role but i am not getting a role here
    async redirect({ url, baseUrl }) {
      // Detect if this is a sign-in redirect (NextAuth calls redirect after login)
      const isCallback = url.includes("callbackUrl");
